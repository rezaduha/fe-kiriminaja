<template>
  <nav ref="target">
    <a href="#">
      <div class="base-container flex">
        <span>#TwogetherStronger</span>
  ...
  <header class="header" :class="{ sticking }">
    <div class="header-container">
      <div class="header-container-body">
        <div class="header-container-body-inner">
          <div class="navbar-menu-container">
            <button class="navbar-menu-icon" @click="handleMobileNav">
          ...
          <NuxtLink to="/" class="logo">
            <svg class="inline h-10" viewBox="0 0 582 165" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <div class="header-container-body-menu" :class="isMobileNavOpen ? 'hidden' : 'block'">
          <ul>
            <li>
              <NuxtLink to="#">Blog</NuxtLink>
            </li>
            <li>
              <NuxtLink to="#">Kabar</NuxtLink>
            </li>
            <li class="relative">
              <button class="btn-service" @click="handleServiceMenu">
                <span>Layanan</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="transition-all absolute right-2.5 top-1/2 -translate-y-1/2"
              ...
              <div v-if="isServiceMenuOpen" class="dropdown-service-content">
                <span class="triangle-shape"></span>
                <div class="dropdown-service-content-item">
                  <NuxtLink href="#">
                    <div
                      class="dropdown-service-content-item-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                        ...
                        <path d="M14 15m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" class="text-orange-300"></path>
                        <path d="M6 21a2 2 0 0 0 2 -2v-5.82a5 5 0 0 0 -.528 -2.236l-1.472 -2.944">
                        </path>
                        <path d="M11 7h2" class="text-orange-300"></path>
                      </svg>
                    </div>
                  </NuxtLink>
                  <div>
                    <h6 class="font-medium">Toko Online Pribadi</h6>
                    <p class="text-sm text-neutral-500">
                      Website toko online pribadi yang terintegrasi
                    </p>
                  </div>
                </div>
                <div class="dropdown-service-content-item">
                  <NuxtLink href="#">
                    <div
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                        ...
                        <path d="M5 11h1v2h-1z" class="text-orange-300"></path>
                        <path d="M10 11l0 2" class="text-orange-300"></path>
                        <path d="M14 11h1v2h-1z" class="text-orange-300"></path>
                        <path d="M19 11l0 2" class="text-orange-300"></path>
                      </svg>
                    </div>
                  </NuxtLink>
                  <div>
                    <h6 class="font-medium">Manajemen Order</h6>
                    <p class="text-sm text-neutral-500">
                ...
                <div class="dropdown-service-content-item">
                  <NuxtLink href="/integration">
                    <div
                      class="dropdown-service-content-item-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                        stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        <path d="M14.828 14.828a4 4 0 1 0 -5.656 -5.656a4 4 0 0 0 5.656 5.656z" class="text-orange-300">
                        </path>
                  ...
                  <div>
                    <h6 class="font-medium">Integrasi API</h6>
                    <p class="text-sm text-neutral-500">
                      Hubungkan bisnis online existingmu dengan kami
                    </p>
                  </div>
                </div>
              </div>
            ...
            <li>
              <NuxtLink to="#">Cek Ongkir</NuxtLink>
            </li>
            <li>
              <NuxtLink to="#">Lacak</NuxtLink>
            </li>
          </ul>
        </div>
        <div class="header-container-body-join" :class="isMobileNavOpen ? 'hidden' : 'block'">
          <ul>
            <li>
              <a href="#">
                <span>Masuk</span>
            ...
            <li>
              <a href="#">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="absolute top-1/2 right-5 -translate-y-1/2"
                  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                  <line x1="5" y1="12" x2="19" y2="12"></line>
...
nav {
  @apply bg-black z-50 top-0 relative h-11 py-2.5 text-sm text-white;

  .more-detail {
    @apply flex gap-3 place-items-center ml-auto;
  }
}

.header {
  @apply text-white xl:h-20 sticky top-0 z-50 transition-all ease-in-out bg-[#1C1B1F];

  &.sticking {
    @apply border-b border-b-neutral-700 transition-all;
  }

  &-container {
    @apply container xl:w-10/12 2xl:w-9/12 mx-auto xl:px-3;

    &-body {
      @apply xl:grid xl:grid-cols-7 w-full place-items-center xl:place-items-start;

      &-inner {
        @apply xl:col-span-2 grid grid-cols-8;

        .navbar-menu {
          &-container {
            @apply xl:hidden col-span-2;
          }
        ...
        .navbar-register {
          @apply col-span-2 text-right xl:hidden relative;
        ...
        .logo {
          @apply text-center xl:text-left my-3 xl:my-0 xl:py-5 block col-span-4 xl:col-span-8;
        }
      }

      &-menu {
        @apply xl:col-span-3 xl:text-center xl:block;

        ul {
          @apply xl:flex xl:gap-5 xl:place-content-center;

          li {
            a {
              @apply block text-sm p-3.5 xl:px-2 xl:py-7;
            }

            .btn-service {
              @apply w-full text-sm xl:text-sm text-left xl:text-center p-3.5 xl:pl-3 pr-10 relative xl:py-7;
            }

            .dropdown-service-content {
              @apply xl:absolute top-full xl:w-96 text-left left-0 xl:bg-[#313033] p-3.5 rounded-3xl shadow-sm;

              .triangle-shape {
                @apply w-4 hidden xl:inline h-4 absolute border-x-8 border-x-transparent border-b-8 border-b-[#313033] top-0 left-7 -translate-y-full;
              }

              &-item {
                @apply flex gap-2 place-items-center relative border border-transparent px-2 hover:bg-neutral-700 hover:border-neutral-600 rounded-2xl;

                &-icon {
                  @apply rounded-full p-2 bg-neutral-600;
                }
              }
            }
          }
      ...
      &-join {
        @apply xl:flex ml-auto xl:col-span-2;

        ul {
          @apply xl:flex xl:gap-7 xl:place-content-end;

          li:first-of-type {
            a {
              @apply block text-sm p-3.5 xl:px-0 xl:py-7;
            }
          }

          li:last-of-type {
            @apply xl:py-4 pt-2 pb-5 px-3 xl:px-0;

            a {
              @apply block text-white py-3 pl-5 pr-14 rounded-full relative bg-[#4f378b] hover:bg-[#6750A4];
            }
          }
        }
      }
